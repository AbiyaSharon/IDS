...
import Modified_ViT
import plot_csi_unsw


########### loading test data ###########

X_test = np.load('x_test_cic_unsw.npy')
Y_test = np.load('Y_test_cic_unsw.npy')
...
model = load_model("model_cic_unsw.h5")
...
print()
Result=plot_csi_unsw.plot(Y_pred,Y_test)
print()
