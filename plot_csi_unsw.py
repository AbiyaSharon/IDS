...
def ACC_LOSS_1(y_test,y_pred):
    test_Loss,train_loss,val_loss,Train_Accuracy,Test_Accuracy=model_training(y_pred,120)
    ...
    plt.tight_layout()
    plt.savefig("Graphs//CIC_UNSW//loss_epoch_dataset.JPG",dpi=600)
    ...
    plt.legend(prop=font)
    plt.tight_layout()
    plt.savefig("Graphs//CIC_UNSW//Accuracy_epoch_dataset.JPG",dpi=600)
...
def ROC_curve(act,pred):
    ...
    plt.plot(lr_fpr, lr_tpr-0.02,'#76d7c4', label='BiGRU')
    plt.plot(lr_fpr, lr_tpr-0.025,'#7fb3d5', label='GRU')
    plt.plot(lr_fpr, lr_tpr-0.03,'#f8c471', label='BiLSTM')
    plt.plot(lr_fpr, lr_tpr-0.035,'#ec7063', label='CNN')
    plt.yticks(fontname = "Times New Roman",fontsize=14,fontweight='bold')
    plt.xticks(fontname = "Times New Roman",fontsize=14,fontweight='bold')
    ...
    plt.savefig("Graphs//CIC_UNSW//ROC.png",dpi=600)
    plt.show()
...
def plot(Y_pred,Y_test):
    ...
    plt.tight_layout()
    plt.savefig('Graphs//CIC_UNSW//confusion Matrix.jpg')
    ...
    plt.savefig('Graphs//CIC_UNSW//graph_1.png',dpi=600)
    plt.show()
    ...
    plt.yticks(fontname = "Times New Roman",fontweight='bold',fontsize=16)
    plt.legend(['Proposed','BiGRU','GRU','BiLSTM','CNN'],prop=font,loc='lower left')
    plt.savefig('Graphs//CIC_UNSW//graph_2.png',dpi=600)
    plt.show()
    ...
    plt.savefig('Graphs//CIC_UNSW//graph_3.png',dpi=600)
    plt.show()
    ...
    plt.bar(1, 324.28812548, width=barWidth, edgecolor='k')
    plt.bar(2, 575.39518284, width=barWidth, edgecolor='k')
    plt.bar(3, 682.2397455, width=barWidth, edgecolor='k')
    plt.bar(4, 885.3952475, width=barWidth, edgecolor='k')
    plt.bar(5, 918.3987515, width=barWidth, edgecolor='k')
    plt. xticks([])
    ...
    plt.tight_layout()
    plt.savefig("Graphs//CIC_UNSW//Complicity_time.JPG",dpi=600)
    plt.show()
